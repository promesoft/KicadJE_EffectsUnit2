...
F 0 "#FLG?" H 3475 1475 50  0001 C CNN
...
F 0 "U?" H 3825 2075 50  0000 C CNN
...
U 1 1 5D5139F5
P 4100 1250
AR Path="/5CF11B19/5D5139F5" Ref="C?"  Part="1" 
AR Path="/5D4DB58B/5D5139F5" Ref="C?"  Part="1" 
AR Path="/5D4DB615/5D5139F5" Ref="C?"  Part="1" 
F 0 "C?" H 4000 1325 50  0000 L CNN
F 1 "100uF 16v" H 3950 1550 50  0000 L CNN
F 2 "Capacitor_THT:CP_Radial_D5.0mm_P2.50mm" H 4138 1100 50  0001 C CNN
...
U 1 1 5D5139FB
P 4100 1550
AR Path="/5CF11B19/5D5139FB" Ref="C?"  Part="1" 
AR Path="/5D4DB58B/5D5139FB" Ref="C?"  Part="1" 
AR Path="/5D4DB615/5D5139FB" Ref="C?"  Part="1" 
F 0 "C?" H 4000 1475 50  0000 L CNN
F 1 "100uF 16v" H 3950 1300 50  0000 L CNN
F 2 "Capacitor_THT:CP_Radial_D5.0mm_P2.50mm" H 4138 1400 50  0001 C CNN
...
F 0 "#PWR?" H 3625 1150 50  0001 C CNN
...
F 0 "C?" H 4300 1650 50  0000 L CNN
...
F 0 "#FLG?" H 4100 1175 50  0001 C CNN
...
F 0 "#FLG?" H 3900 1775 50  0001 C CNN
...
F 0 "C?" H 4500 1650 50  0000 L CNN
...
F 0 "C?" H 4500 1175 50  0000 L CNN
...
F 0 "U?" H 3825 2150 50  0000 C CNN
...
F 0 "H?" H 1300 821 50  0000 L CNN
...
F 0 "H?" H 1300 1021 50  0000 L CNN
...
F 0 "H?" H 850 1021 50  0000 L CNN
...
AR Path="/5D4DB615/5D513AB5" Ref="J?"  Part="1" 
F 0 "J?" H 3122 3457 50  0000 R CNN
...
AR Path="/5D4DB615/5D513AC9" Ref="#PWR?"  Part="1" 
F 0 "#PWR?" H 2850 3275 50  0001 C CNN
...
F 0 "U?" H 4875 3675 50  0000 C CNN
...
F 0 "U?" H 5750 3725 50  0000 C CNN
...
Wire Wire Line
	2725 3925 2950 3925
Text Label 2725 3125 0    50   ~ 0
Pot1_h
Text Label 2725 3225 0    50   ~ 0
Pot1_c
Text Label 2725 3325 0    50   ~ 0
Pot1_l
Text Label 2725 3925 0    50   ~ 0
Pot2_l
Text Label 2725 3825 0    50   ~ 0
Pot2_c
...
AR Path="/5D4DB615/5D523E0C" Ref="J?"  Part="1" 
F 0 "J?" H 3122 4457 50  0000 R CNN
...
AR Path="/5D4DB615/5D523E18" Ref="#PWR?"  Part="1" 
F 0 "#PWR?" H 2850 4275 50  0001 C CNN
...
Wire Wire Line
	2725 4925 2950 4925
Text Label 2725 4125 0    50   ~ 0
Pot3_h
Text Label 2725 4225 0    50   ~ 0
Pot3_c
Text Label 2725 4325 0    50   ~ 0
Pot3_l
Text Label 2725 4925 0    50   ~ 0
Pot4_l
Text Label 2725 4825 0    50   ~ 0
Pot4_c
Text Label 2725 4725 0    50   ~ 0
Pot4_h
$EndSCHEMATC
